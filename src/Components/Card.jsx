    ...
    return (
        <div className='p-3 rounded-xl shadow-xl '>
            ...
            <div> <p>{truncateDescription(description, 10)}</p></div>
                ...
                <Link to={`/model-details/${_id}`} className=' mt-4 btn rounded-full bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 text-white font-semibold  py-2  w-full'>View Details</Link>
